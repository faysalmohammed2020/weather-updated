...
import HijlaStation from "./station_pressure_level/Hijla-station_level";
import HijlaSea from "./station_pressure_level/Hijla-sea_level"

import KawkhaliStation from "./station_pressure_level/Kawkhali-station_level";
import KawkhaliSea from "./station_pressure_level/Kawkhali-sea_level"

import ManikganjStation from "./station_pressure_level/Manikganj-station_level";
import ManikganjSea from "./station_pressure_level/Kawkhali-sea_level"

import NarsingdiStation from "./station_pressure_level/Narsingdi-station_level";
import NarsingdiSea from "./station_pressure_level/Narsingdi-sea_level"
...
export const stationDataMap = {
  ...
  [HijlaStation.station.station_no]: {
    station: HijlaStation,
    sea: HijlaSea,
  },
  [KawkhaliStation.station.station_no]: {
    station: KawkhaliStation,
    sea: KawkhaliSea,
  },
  [ManikganjStation.station.station_no]: {
    station: ManikganjStation,
    sea: ManikganjSea,
  },
  [NarsingdiStation.station.station_no]: {
    station: NarsingdiStation,
    sea: NarsingdiSea,
  },
  [MonpuraStation.station.station_no]: {
    station: MonpuraStation,
    sea: MonpuraSea,
  },
