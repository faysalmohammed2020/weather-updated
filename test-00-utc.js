...
suite.test("00 UTC: Date should be previous day", function () {
  ...
  this.assertEquals(
    actualDate,
    expectedDate,
    "Date should be previous day when UTC=00"
  );
});
...
suite.test("03 UTC: Date should be current day", function () {
  ...
  this.assertEquals(
    actualDate,
    expectedDate,
    "Date should be today when UTC=03"
  );
});
...
suite.test("00 UTC: WMO window H-6 calculation", function () {
  ...
  this.assertEquals(
    actualTime,
    expectedTime,
    "H-6 should be 6 hours before observation"
  );
});
...
suite.test("00 UTC: WMO window H-3 calculation", function () {
  ...
  this.assertEquals(
    actualTime,
    expectedTime,
    "H-3 should be 3 hours before observation"
  );
});
...
suite.test("00 UTC: Intermittent rain in first half tr=1", function () {
  ...
  this.assertEquals(
    tr,
    "1",
    "Intermittent rain in first half should have tr=1"
  );
});
...
suite.test("00 UTC: Intermittent rain in second half tr=2", function () {
  ...
  this.assertEquals(
    tr,
    "2",
    "Intermittent rain in second half should have tr=2"
  );
});
...
suite.test("00 UTC: Intermittent rain spanning both halves tr=3", function () {
  ...
  this.assertEquals(
    tr,
    "3",
    "Intermittent rain spanning full period should have tr=3"
  );
});
...
suite.test("Multiple slots: Gap calculation", function () {
  ...
  this.assert(
    isIntermittent,
    `Gap should be >= 30 min for intermittent. Gap: ${gap}`
  );
});
...
suite.test("Cross-midnight: End < Start means next day", function () {
  ...
  this.assertEquals(
    duration,
    expectedDuration,
    "Cross-midnight duration should be calculated correctly"
  );
});
...
suite.test("6RRRtR field: Construction at 00 UTC", function () {
  ...
  this.assertEquals(
    field,
    "60081",
    "6RRRtR field should be constructed correctly"
  );
});
...
suite.test("Bangladesh calendar: 00 UTC rule message", function () {
  ...
  this.assertEquals(
    rule,
    "00 UTC → Previous date",
    "Should show previous date for 00 UTC"
  );
});
...
suite.test("Bangladesh calendar: 06 UTC rule message", function () {
  ...
  this.assertEquals(
    rule,
    "06 UTC → Present date",
    "Should show present date for 06 UTC"
  );
});
