...
import type { Station as ServerStation } from "@/lib/server/user-data";

interface Station extends ServerStation {
  latitude: number;
  longitude: number;
}

interface StationManagementClientProps {
