                ...
                <CardContent className="pt-8 pb-6 px-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      value={(session?.user as any)?.station?.name ?? ""}
                          ...
                          >
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                maxLength={3}
                                value={
                                  formik.values.airTemperature[
                                    dryKey as keyof typeof formik.values.airTemperature
                                  ] || ""
                                }
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                value={
                                  formik.values.airTemperature[
                                    wetKey as keyof typeof formik.values.airTemperature
                                  ] || ""
                                }
                                onChange={handleThreeDigitInput}
                                className="border border-slate-300 h-10 rounded-lg"
                  ...
                  <div className="space-y-8">
                        ...
                        {[
                          ...
                          <div key={key} className="space-y-2">
                            ...
                            <Input
                              ...
                              maxLength={3}
                              value={
                                formik.values.soilTemperature[
                                  key as keyof typeof formik.values.soilTemperature
                                ] || ""
                              }
                              onChange={handleThreeDigitInput}
                              className="border border-slate-300 h-10 rounded-lg"
                    ...
                    <div className="p-6 bg-teal-50/50 rounded-xl border border-teal-200">
                      <h4 className="font-bold text-teal-700 text-lg mb-4">
                        Soil Moisture % Between (Auto-filled)
                      </h4>
                  ...
                  <div className="p-6 bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div className="flex items-center p-3 bg-white rounded-lg">
                        ...
                        <span className="font-medium">
                          Temperature:{" "}
                          {formik.values.minTemp ? "Complete" : "Pending"}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center p-3 bg-white rounded-lg">
                        ...
                        <span className="font-medium">
                          Weather:{" "}
                          {formik.values.windSpeed ? "Complete" : "Pending"}
                        </span>
                      </div>
                    </div>
                  </div>
